        ...
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold">Apprentice / Entry-Level Welder</h3>
                    <p className="text-sm text-slate-600">Learn foundational skills on the job, assisting senior welders.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold">Certified Welder / Technician</h3>
                    <p className="text-sm text-slate-600">Work independently on complex projects, holding key certifications (AWS).</p>
                  </div>
                </div>
                <div className="ml-4 h-8 border-l-2 border-slate-300"></div>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold">Senior / Master Welder or Inspector (CWI)</h3>
                    <p className="text-sm text-slate-600">Lead projects, train others, or ensure quality as a Certified Welding Inspector.</p>
                  </div>
                </div>
                 <div className="ml-4 h-8 border-l-2 border-slate-300"></div>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold">Supervisor / Business Owner</h3>
                    <p className="text-sm text-slate-600">Manage teams of welders or start your own fabrication business.</p>
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-bold flex items-center"><ListChecks className="w-5 h-5 mr-2 text-blue-600"/>Skills Required</h3>
              <ul className="mt-3 list-disc list-inside text-slate-600 text-sm space-y-1">
                <li>MIG, TIG, Stick & Flux-Cored Welding</li>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
             ...
             {/* Certifications */}
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-bold flex items-center"><ShieldCheck className="w-5 h-5 mr-2 text-blue-600"/>Top Certifications</h3>
              <ul className="mt-3 list-disc list-inside text-slate-600 text-sm space-y-1">
                <li>AWS Certified Welder</li>
                <li>Certified Welding Inspector (CWI)</li>
                <li>NCCER Certifications</li>
              </ul>
            </div>
          </div>
        </div>
