      ...
      <div className="container mx-auto max-w-4xl py-12 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow"><h3 className="text-lg font-bold flex items-center"><DollarSign className="w-5 h-5 mr-2 text-blue-600"/>Earning Potential</h3><p className="mt-2 text-slate-600 text-sm">Median Pay: **$62,280 per year**<br/>Top 10% Earn: **>$97,090 per year**</p><p className="text-xs text-slate-400 mt-2">(Source: U.S. BLS, Industrial Machinery Mechanics)</p></div>
