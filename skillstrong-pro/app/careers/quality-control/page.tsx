      ...
      <div className="container mx-auto max-w-4xl py-12 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow"><h3 className="text-lg font-bold flex items-center"><DollarSign className="w-5 h-5 mr-2 text-blue-600"/>Earning Potential</h3><p className="mt-2 text-slate-600 text-sm">Median Pay: **$45,950 per year**<br/>Top 10% Earn: **>$75,340 per year**</p><p className="text-xs text-slate-400 mt-2">(Source: U.S. BLS, QC Inspectors)</p></div>
